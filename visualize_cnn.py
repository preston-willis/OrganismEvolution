...
print(f"  Conv1: 6 channels -> 32 channels, kernel_size=3, stride=1")
print(f"  Conv2: 32 channels -> 13 channels, kernel_size=1")
print(f"  Output: proportions (3x3), sharing_rate, hidden_channels (3)")
